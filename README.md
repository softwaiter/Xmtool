...
```shell
Install-Package Xmtool -Version 2.0.11
```

##### .NET CLI

```shell
dotnet add package Xmtool --version 2.0.11
```

##### PackageReference

```xml
<PackageReference Include="Xmtool" Version="2.0.11" />
```

##### Paket CLI

```shell
paket add Xmtool --version 2.0.11
```
